...
CREATE TABLE `dev` (
  ...
  `devID` int(6) NOT NULL AUTO_INCREMENT,
  `ipAddress` varchar(20) NOT NULL,
  PRIMARY KEY (`devID`),
  KEY `fk` (`userID`),
  CONSTRAINT `fk` FOREIGN KEY (`userID`) REFERENCES `usr` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2019-10-22  9:56:37
